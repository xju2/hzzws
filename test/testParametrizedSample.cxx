...
void generate_para_ws()
{
    ...
    ***/
    ...
    const char* norm_sys = "norm_ggF_125_Low.txt";
    const char* shape_sys = "ggF_125_Low_Shape.root";
    auto* sample_h124 = new SampleHist("ATLAS_Signal_ggH124", "ggF", "test_ggH_200.root", shape_sys, norm_sys, path);
    auto* sample_h125 = new SampleHist("ATLAS_Signal_ggH125", "ggF", "test_ggH_300.root", shape_sys, norm_sys, path);
    auto* sample_h126 = new SampleHist("ATLAS_Signal_ggH126", "ggF", "test_ggH_400.root", shape_sys, norm_sys, path);
    auto* sample_h127 = new SampleHist("ATLAS_Signal_ggH127", "ggF", "test_ggH_500.root", shape_sys, norm_sys, path);
    auto* sample_h128 = new SampleHist("ATLAS_Signal_ggH128", "ggF", "test_ggH_600.root", shape_sys, norm_sys, path);
    ...
    RooProduct* coeff = (RooProduct*) sample_ggF->getCoeff();
    pdf->Print();
    coeff->Print();
...
void generate_keys_ws()
{
    ...
    auto* sample_h124 = new SampleKeys("ATLAS_Signal_ggH124", "ggF", 124, 110, 140,
            f1, norm_sys, norm_sys, path);
    auto* sample_h125 = new SampleKeys("ATLAS_Signal_ggH125", "ggF", 125, 110, 140, 
            f2, norm_sys, norm_sys, path);
    auto* sample_h126 = new SampleKeys("ATLAS_Signal_ggH126", "ggF", 126, 110, 140,
            f3, norm_sys, norm_sys, path);
