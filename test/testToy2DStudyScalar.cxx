...
int main(int argc, char** argv)
{
    ...
    int n_xbins = 80, n_ybins = 20;
    TH2F* h2_template = new TH2F("h2_template", "2D template", n_xbins, 200, 1800, n_ybins, 0.00, 0.1);
    ...
    for(int itoy = 0; itoy < ntoys; itoy++)
    {
        ...
        for(int ix = 1; ix < n_xbins+1; ix++) 
        {
            ...
            double width = kappa_input * fix_mass_val;
            cout<<"kappa: " << kappa_input << ", mG: "<< fix_mass_val << ", width: " << width << endl;
