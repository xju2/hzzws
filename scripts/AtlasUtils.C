...
void myText(Double_t x,Double_t y,Color_t color, const char *text, bool use_ndc = true) {
...
void myBoxText(Double_t x, Double_t y,Double_t textsize,Int_t mcolor,const char *text) 
{
...
void myBoxText(Double_t x, Double_t y, const TAttFill& h1 ,const char *text, Double_t textsize) 
{
...
void myLineText(Double_t x, Double_t y, const TAttLine& line, const char* text, float textsize = 0.04)
{
    myLineText(x, y, line.GetLineColor(), line.GetLineStyle(), text, 0.04);
}

void myLineMarkerText(Double_t x, Double_t y, const TH1& h1, const char* text)
{
    double msize = 0.04;
...
void SetXTitle(TH1* h1, const char* title)
{
    h1->SetXTitle(title);
...
void ATLAS(double x, double y, int opt = 0)
{
    switch(opt){
        case 1:
