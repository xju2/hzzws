...
el_shape_list = ["ATLAS_EL_RES", "ATLAS_EL_ESCALE"]
mu_shape_list = ["ATLAS_MU_MS_RES_ID", "ATLAS_MU_MS_RES_MS", "ATLAS_MU_ESCALE"]
el_sys_list = el_shape_list + ["ATLAS_EL_EFF_ID", "ATLAS_EL_EFF_RECO",
                               "ATLAS_EL_EFF_ISO"]
mu_sys_list = mu_shape_list + ["ATLAS_MU_EFF_STAT", 
                               "ATLAS_MU_EFF_SYS",
...
other_shapes = ["ATLAS_HOEW_QCD", "ATLAS_Shape_Zjet"]
theory_list = ["QCDscale_VV", "QCDscale_ggVV", 
               "pdf_gg", "pdf_qq",
               "ATLAS_lumi_2015",
               #"ATLAS_NLO_QCD",
               "ATLAS_HOEW",
...
def update_lumi(file_name):
    ...
    with open(file_name, 'r') as f:
        for line in f:
            if "ATLAS_lumi_2015" in line:
                out += "ATLAS_lumi_2015 = 0.95 1.05\n"
            else:
                out += line
    with open(file_name, 'w') as f:
        f.write(out)
